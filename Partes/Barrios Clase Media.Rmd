...
```{r Urls: Fuente de datos, message=FALSE}
...
ggplot() + 
  ...
  geom_sf(data = barrioscm_gg, aes(fill = nombre, alpha = 0.2), color = "white", size = 0.2) +
...
>>>>>>> 672d808b98f44df66021e8cf0e12c49b649f41c6
...
<<<<<<< HEAD
=======
```{r visualizacion cantidad de escuelas publicas y privadas}
ggplot(escuelas_cmbuffer, aes(x = barrios_nom, fill = tipo_gestion)) +
