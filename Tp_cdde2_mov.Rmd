...
leaflet() %>%
  ...
  addPolygons(data = barrios_cmym,
              ...
              fillOpacity = 0.6,
              label = ~barrios) %>% 
  addCircleMarkers(data = barrios_pcomp,
                   radius = 6,
                   color = "darkorange",
                   fillColor = "orange",
                   fillOpacity = 0.8,
                   stroke = FALSE,
                   label = ~paste0(barrio, ": ", escuela_cercana),
                   popup = ~paste0(
                     "<strong>Barrio:</strong> ", barrio, "<br>",
                     "<strong>Escuela más cercana:</strong> ", escuela_cercana, "<br>",
                     "<strong>Distancia:</strong> ", round(distancia_km, 2), " km"
                   ))
