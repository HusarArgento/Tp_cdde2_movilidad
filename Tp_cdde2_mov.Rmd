...
```{r Operaciones}
barrios3 <- st_transform(barrios3, 4326)
st_crs(barrios3)
comunas <- st_transform(comunas, 4326)
st_crs(comunas)

barrios_j <- st_join(barrios3, comunas, join = st_intersects) #Unimos solo las partes de la geometría que se intersectan
barrios_j2 <- st_join(comunas, barrios3, join = st_intersects) #Unimos solo las partes de la geometría que se intersectan
