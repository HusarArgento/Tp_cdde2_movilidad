...
escuelas_con_barrios <- st_join(educ2, buffers_multi, join = st_intersects)
...
ggplot() +
  ...
  geom_sf(data = educ2, aes(color = tipo_gestion), size = 1.5) +
  geom_sf(data = buffers_multi, aes(fill = distancia), alpha = 0.05) +
