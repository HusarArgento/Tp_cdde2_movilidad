...
barrios_vul_selec_wgs <- st_transform (barrios_vul_selec,4326)

leaflet() %>%
  addProviderTiles("CartoDB.Positron") %>%
    addPolygons(data = barrios_vul_selec_wgs,
              fillColor = "red",
              color = "darkred",
              weight = 1,
              fillOpacity = 0.6,
